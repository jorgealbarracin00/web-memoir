...
export function PrivacyPage() {
  return <><Seo title="Privacy Policy" description="Read how Memoir handles recordings, memoir content, AI processing, iCloud, photos, purchases, and deletion." path="/privacy" />
    ...
    <section><h2>4. AI Processing</h2><p>Memoir never sends your memoir content to an external AI service unless you have explicitly granted permission inside the app. When AI processing is enabled, Memoir currently uses OpenAI to help organize memories, improve readability while preserving your voice, generate chapter structure, and create Narrator Mirror observations. Depending on the feature you request, Memoir sends only the information reasonably necessary to provide that feature, which may include your dictated or written memoir text, Echo drafts, Sparks, chapter information, selected mood or tone, and limited Narrator Mirror context. You may withdraw AI permission at any time from Settings. Doing so prevents future AI requests but does not remove memoir content already saved on your device. OpenAI's handling of information is governed by its applicable privacy and service terms.</p></section>
    ...
    <section><h2>10. Data Deletion</h2><p>The app includes a <strong>Delete My Memoir</strong> feature that deletes memoir content managed by Memoir from the device, including Echoes, Chapters, Sparks, Narrator Mirror information, and app-managed photo attachments. When iCloud synchronization is enabled, corresponding cloud deletion is requested and may complete when iCloud becomes available. This does not remove PDF exports you previously created, copies shared with other people, or Apple purchase history. Disabling AI processing prevents future AI requests but does not delete memoir content already created.</p></section>
